...
public class AdminMenu extends Menu {
    ...
    public AdminMenu(BaseRequestController contr, AccountDTO accountDTO, UserInfoDTO userInfoDTO) {
        super(contr);
    ...
    public void start() throws IOException {
        System.out.println("Добро пожаловать, админ: " + accountDTO.getUsername() + "!");
        ...
        while (!toExit) {
            ...
            switch (command) {
                ...
                case ADD_MANAGER:
                    ...
                    break;
                case GET_USER_LIST:
                    allUsersController.sendAllUsers();
                    break;
                case CHANGE_ACCESS_LEVEL:
                    allUsersController.changeAccess();
                    break;
